...
do
  ...
  -- (Removed Kickstart <leader>q mapping in favor of LazyVim <leader>xq)
...
do
  ...
  vim.pack.add { { src = gh 'bjarneo/aether.nvim', version = 'v3', name = 'aether' } }
  ...
  -- Load the customized aether colorscheme
  vim.cmd.colorscheme 'aether'

  -- Enforce transparency globally
...
do
  ...
  -- Bufferline (tabs at the top like LazyVim)
  ...
  require 'custom.lazyvim_keymaps'
end
...
local servers = {
  -- ... other servers like pyright, lua_ls, etc.

  -- Handles Vue template and CSS
  volar = {
    init_options = {
      vue = {
        hybridMode = false, -- Set to true if you want Volar to strictly use ts_ls for script tags
      },
    },
  },

  -- Handles JavaScript/TypeScript, needs to be aware of the Vue plugin
  ts_ls = {
    init_options = {
      plugins = {
        {
          name = '@vue/typescript-plugin',
          -- This dynamically resolves the path to the Vue TS plugin from Mason
